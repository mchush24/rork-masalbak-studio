...
export const PROTOCOLS: Record<string, Protocol> = {
  DAP: {
    ...
    phases: [
      ...
      },
      {
        name: 'Yönerge',
        instruction:
          'Bu kağıda bir insan çiz. İstediğin gibi çizebilirsin. Bitirdiğinde bana haber ver.',
        notes: [
    ...
    phases: [
      {
        name: '1. Ev Çizimi',
        instruction:
          'Bu kağıda bir ev çiz. İstediğin türde bir ev olabilir. Bitirdiğinde haber ver.',
        duration: '~10 dakika',
        notes: [
      ...
      },
      {
        ...
        duration: '~10 dakika',
        notes: ['Yeni kağıt ver (dikey)', "Eğer 'Ne tür ağaç?' diye sorarsa: 'İstediğin tür' de"],
      },
      {
      ...
      },
      {
        name: '3. İnsan Çizimi',
        instruction:
          'Şimdi bu kağıda bir insan çiz. Tam bir insan, sadece yüz değil. Bitirdiğinde haber ver.',
        duration: '~10 dakika',
        notes: [
    ...
    phases: [
      {
        name: 'Yönerge',
        instruction:
          'Ailendeki herkesi, kendini de dahil ederek çiz. Herkes bir şeyler yapıyor olsun. Çöp adam değil, gerçek insanlar çiz. Bitirdiğinde haber ver.',
        notes: [
          'Kağıdı yatay ver',
    ...
    phases: [
      {
        name: 'Yönerge',
        instruction:
          'Bu kağıda bir kaktüs çiz. İstediğin gibi çizebilirsin. Bitirdiğinde haber ver.',
        notes: [
          'Kağıdı dikey ver',
  ...
  Agac: {
    ...
    materials: ['A4 beyaz kağıt', 'HB kurşun kalem', 'Silgi'],
    phases: [
      {
        name: 'Yönerge',
        instruction:
          'Bu kağıda bir ağaç çiz. Meyve ağacı dışında, istediğin türde bir ağaç. Bitirdiğinde haber ver.',
        notes: [
          'Kağıdı dikey ver',
    ...
    requiredImages: [{ id: 'tree', label: 'Ağaç Çizimi', description: 'Çocuğun çizdiği ağaç' }],
  },
  ...
  Bahce: {
    ...
    phases: [
      {
        name: 'Yönerge',
        instruction:
          'Bu kağıda bir bahçe çiz. İstediğin türde bir bahçe olabilir. Bitirdiğinde haber ver.',
        notes: [
    ...
    requiredImages: [{ id: 'garden', label: 'Bahçe Çizimi', description: 'Çocuğun çizdiği bahçe' }],
  },
    ...
    phases: [
      {
        name: 'Hazırlık',
        instruction:
          'Masayı temizle, dikkat dağıtıcı şey olmasın. Kağıdı ve kalemi çocuğun önüne koy.',
        notes: [
          'Kağıt dikey konumda',
      ...
      },
      {
        name: 'Kopya Aşaması',
        instruction:
          'Sana bazı kartlar göstereceğim. Her kartta bir şekil var. Şekli bu kağıda, gördüğüne en yakın şekilde çiz. Hazır mısın?',
      ...
      },
      {
        ...
        instruction:
          'Şimdi, sana gösterdiğim şekilleri hatırladığın kadar çiz. Kartlarda gördüğüne benzer şekilde çizmeye çalış. İstediğin kadar zaman alabilirsin.',
        duration: '~5 dakika',
        notes: [
      ...
      },
      {
        ...
        instruction:
          'Şimdi sana başka kartlar göstereceğim. Her kartta üç şekil var. Ortadaki şekle en çok benzeyeni bul ve göster.',
        duration: '2-4 dakika',
        notes: [
    ...
    requiredImages: [
      {
        id: 'copy',
        label: 'Kopya Sayfası',
        description: 'Stimulus kartlara bakarak çizilen sayfa(lar)',
      },
      {
        id: 'recall',
        label: 'Hatırlama Sayfası',
        description: 'Bellekten çizilen sayfa',
        optional: true,
      },
    ],
  },
  ...
  Rey: {
    ...
    phases: [
      {
        name: 'Kopya Aşaması',
        instruction:
          'Bu şekle bak. Aynı şekli bu kağıda olabildiğince doğru bir şekilde çiz. Acelemiz yok, istediğin kadar zaman alabilirsin.',
      ...
      },
      {
        ...
        instruction:
          'Şimdi az önce çizdiğin şekli hatırladığın kadar yeniden çiz. Bakmadan, sadece hatırladığın kadarıyla çiz.',
      ...
      },
      {
        ...
        instruction:
          'Şimdi en baştaki şekli tekrar hatırlayarak çiz. Bakmadan, hatırladığın kadarıyla.',
      ...
      },
      {
        ...
        instruction:
          'Şimdi sana bazı şekiller göstereceğim. Bunlardan hangileri en başta gördüğün büyük şeklin parçasıydı?',
        notes: [
    ...
    requiredImages: [
      { id: 'copy', label: 'Kopya Çizimi', description: 'Stimulus karta bakarak çizilen şekil' },
      {
        id: 'immediate',
        label: 'Ani Hatırlama',
        description: '3 dk sonra bellekten çizilen şekil',
      },
      {
        id: 'delayed',
        label: 'Gecikmeli Hatırlama',
        description: '20-30 dk sonra bellekten çizilen şekil',
        optional: true,
      },
    ],
  },
  ...
  Luscher: {
    ...
    phases: [
      ...
      },
      {
        ...
        instruction:
          'Bu renklere bak. Şimdi en çok hoşuna gideni seç. Hiç düşünme, içinden geldiği gibi seç.',
        notes: [
      ...
      },
      {
        ...
        duration: '2-3 dakika',
        notes: ['Renkler tekrar rastgele sıralanır', 'Önceki seçimi hatırlamaması için kısa ara'],
      },
      {
        name: 'İkinci Seçim Turu',
        instruction:
          'Şimdi tekrar aynı şeyi yapacağız. Önceki seçimini hatırlamaya çalışma. Şimdi en çok hoşuna giden rengi seç.',
        notes: [
...
export const getSimpleProtocol = (key: string) => {
  ...
  return {
    ...
    steps: protocol.phases.map(p =>
      p.notes && p.notes.length > 0 ? `${p.name}: ${p.instruction}` : p.instruction
    ),
...
export const PROTOCOL_KEYS = Object.keys(PROTOCOLS) as (keyof typeof PROTOCOLS)[];
