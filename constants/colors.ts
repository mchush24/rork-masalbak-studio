...
export const Colors = {
  ...
  background: {
    ...
    // Unified page background for all tabs
    page: '#FAFBFC',
    pageGradient: ['#FAFBFC', '#F5F6F8', '#FFFFFF'] as const,
    ...
    profile: ['#F0FDF4', '#DCFCE7', '#BBF7D0'] as const, // Yeşil geçişi (legacy)
...
export const DarkColors = {
  ...
  background: {
    ...
    // Unified page background for all tabs (dark)
    page: '#12141D',
    pageGradient: ['#12141D', '#161922', '#1A1D28'] as const,
...
export const ProfessionalDarkColors = {
  ...
  data: {
    ...
    neutral: '#737373',
    highlight: '#5BA3B8',
    series: ['#5BA3B8', '#8FD4A8', '#FFAA70', '#B8A8D4', '#F28B8B', '#6BBDD2'] as const,
  },
