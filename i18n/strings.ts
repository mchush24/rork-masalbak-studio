...
export const strings: Record<Language, TranslationKeys> = {
  tr: {
    ...
    home: {
      title: 'MasalBak',
      subtitle: 'Çocukların hayal dünyasını keşfedin',
    ...
    studio: {
      ...
      cancel: 'Vazgeç',
      shareMessage: 'MasalBak Boyama PDF:',
  ...
  en: {
    ...
    home: {
      title: 'MasalBak',
      subtitle: 'Discover children\'s imagination',
    ...
    studio: {
      ...
      cancel: 'Cancel',
      shareMessage: 'MasalBak Coloring PDF:',
  ...
  de: {
    ...
    home: {
      title: 'MasalBak',
      subtitle: 'Entdecken Sie die Fantasie der Kinder',
  ...
  ru: {
    ...
    home: {
      title: 'MasalBak',
      subtitle: 'Откройте мир детского воображения',
    ...
    studio: {
      ...
      cancel: 'Отмена',
      shareMessage: 'MasalBak PDF раскраска:',
