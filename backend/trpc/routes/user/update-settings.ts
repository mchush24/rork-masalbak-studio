...
export const updateSettingsProcedure = protectedProcedure
  ...
  .mutation(async ({ ctx, input }) => {
    ...
    if (settings.dataSharingConsent !== undefined)
      updateData.data_sharing_consent = settings.dataSharingConsent;
    ...
    if (settings.childLockEnabled !== undefined)
      updateData.child_lock_enabled = settings.childLockEnabled;
