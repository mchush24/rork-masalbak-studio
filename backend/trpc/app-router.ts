...
import {
  listStorybooksProcedure,
  listColoringsProcedure,
  deleteStorybookProcedure,
  deleteColoringProcedure,
} from './routes/studio/list-history.js';
...
import {
  recordColoringActivityProcedure,
  getColoringStatsProcedure,
} from './routes/coloring/record-activity.js';
